...
_INTENT_KEYWORDS = {
    'transport': {'aeroporto', 'aeroporti', 'bus', 'tram', 'metro', 'treno', 'taxi', 'trasporto', 'trasporti',
                  'transport', 'transportation', 'airport', 'airports', 'subway', 'train', 'trains', 'buses',
                  'gira', 'girare', 'muoversi', 'spostarsi', 'mobilità', 'raggiungere', 'arrivare',
                  'arrivo', 'partenza', 'stazione', 'fermata', 'volo', 'volare', 'getting', 'reach', 'travel'},
    'hotel': {'hotel', 'hotels', 'hostel', 'hostels', 'alloggio', 'albergo', 'b&b', 'ostello',
              'accommodation', 'accommodations', 'dormire', 'pernottare', 'stay', 'sleep', 'lodging'},
    'attractions': {'museo', 'musei', 'monumento', 'monumenti', 'piazza', 'attrazioni', 'vedere', 'visitare',
                    'colosseo', 'vaticano', 'chiesa', 'palazzo', 'parco', 'tour', 'turismo',
                    'museum', 'museums', 'monument', 'landmarks', 'landmark', 'sight', 'sights',
                    'visit', 'attraction', 'attractions', 'square', 'see'},
    'safety': {'sicurezza', 'sicuro', 'pericolo', 'criminalità', 'pericoloso', 'rischio', 'rischioso',
               'safety', 'safe', 'dangerous', 'crime', 'crimes', 'secure'},
    'nightlife': {'bar', 'bars', 'pub', 'pubs', 'drink', 'drinks', 'beer', 'beers', 'nightclub', 'nightclubs',
                  'club', 'clubs', 'nightlife', 'aperitivo', 'bere', 'birra', 'locale', 'cocktail',
                  'lounge', 'biergarten', 'drinking'},
    'districts': {'distretto', 'distretti', 'quartiere', 'quartieri', 'zona', 'zone',
                  'district', 'districts', 'neighborhood', 'neighborhoods', 'quarter', 'quarters',
                  'area', 'areas', 'borough', 'boroughs'},
}
...
_INTENT_WEIGHTS: dict[str, dict[str, int]] = {
    'transport': {'aeroporto': 5, 'aeroporti': 5, 'bus': 4, 'tram': 4, 'metro': 4, 'treno': 4, 'taxi': 3,
                  'trasporto': 4, 'trasporti': 4, 'airport': 5, 'airports': 5,
                  'subway': 4, 'train': 4, 'trains': 4, 'transport': 4, 'transportation': 4},
    'hotel': {'hotel': 5, 'hotels': 5, 'hostel': 4, 'hostels': 4, 'alloggio': 5, 'albergo': 4,
              'b&b': 4, 'ostello': 4, 'accommodation': 5, 'stay': 4, 'sleep': 4, 'lodging': 4},
    'attractions': {'museo': 4, 'musei': 4, 'monumento': 4, 'piazza': 3, 'vedere': 5, 'visitare': 5,
                    'colosseo': 5, 'vaticano': 4, 'museum': 4, 'museums': 4,
                    'landmark': 4, 'landmarks': 4, 'sight': 4, 'sights': 4, 'visit': 5, 'see': 4},
    'safety': {'sicurezza': 5, 'sicuro': 4, 'pericolo': 4, 'criminalità': 4,
               'safety': 5, 'safe': 4, 'crime': 4, 'crimes': 4, 'dangerous': 4},
    'nightlife': {'bar': 5, 'bars': 5, 'pub': 5, 'pubs': 5, 'nightclub': 5, 'nightclubs': 5,
                  'club': 4, 'clubs': 4, 'drink': 4, 'drinks': 4, 'beer': 4, 'beers': 4,
                  'nightlife': 5, 'cocktail': 3, 'aperitivo': 4, 'birra': 4, 'drinking': 4},
    'districts': {'district': 5, 'districts': 5, 'neighborhood': 5, 'neighborhoods': 5,
                  'quarter': 4, 'quarters': 4, 'quartiere': 5, 'distretti': 5, 'area': 3, 'areas': 3},
