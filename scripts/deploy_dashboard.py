...
sicurezza, accessibilità economica. Tono: analitico, da report istituzionale.</pre>
  ...
  <p style="margin-top:20px;">
    ...
    manualmente dal sito Wikivoyage in formato dump MediaWiki XML. Le immagini landmark
    provengono da <b>Wikimedia Commons</b> (licenza libera) tramite Wikipedia pageimages API.
  </p>
